...
# blind 재검증을 거친 라벨은 독립 판정이다 — AI 판정을 보지 않고 내렸다.
BLIND_STATUSES = frozenset({"HUMAN_BLIND_CONFIRMED", "HUMAN_BLIND_CORRECTED"})
LABELLED_STATUSES = INDEPENDENT_STATUSES | BLIND_STATUSES | {AI_ASSISTED_STATUS}
