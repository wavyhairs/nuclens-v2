...
// -------------------------------
// 예전 판(v1)은 박아 뒀고, 그래서 키를 갈면 app.js 를 고쳐 다시 배포해야 했다.
...
// 채로 둔다. "설정하지 않은 것"과 "고장난 것"이 화면에서 갈린다.

import { json, vapidConfig } from "./_shared.js";

export async function onRequestGet({ env }) {
  const { publicKey } = vapidConfig(env);
